...
describe('LocationsService', () => {
  ...
  let fixture: ComponentFixture<LocationsService>;
  let expectedCities = [
    {
      id: 1,
      name: "Huntsville",
  ...
  it('cities should return the proper city list', () => {
    let returned = service.cities();
    expect(returned).toEqual(expectedCities);
  });
});
